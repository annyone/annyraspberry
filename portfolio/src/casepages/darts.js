    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-[1600px] w-full mx-auto">
        ...
        <Section className="gap-4">
          ...
          <Text variant="h4" className='mt-8'>Создание игрока</Text>
          ...
          <Text variant="h4" className='mt-8'>Создание турнира</Text>
        ...
        <Section className="gap-4">
          ...
          <Text variant="h4" className='mt-8'>Проверка документов перед турниром</Text>
          ...
          <Text variant="h4" className='mt-8'>Формирование групп</Text>
          ...
          <Text variant="h4" className='mt-8'>Завершение турнира</Text>
